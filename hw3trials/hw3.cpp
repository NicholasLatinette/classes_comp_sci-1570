...
do //this loop is made so that whenever the program is started, it will continue until someone tells it that there are no more patients left.
{
  ...
  {
  cout << "Each surgery will cost $" << price << ". How many surguries would you like to have " << name << "?" << endl;
  cin >> surg;
  ...
  cout << "You could still get " << static_cast<short>(surg2) << " more surguries today. Still, come on in!" << endl;
  }
  else if (total < price)
  {
  ...
  cout << "Sorry " << name << ", you can only afford " << static_cast<short>(surg3) << ". Come on in!" << endl;
  }
  ...
  cout << name << " ,you could still get " << static_cast<short>(surg2) << " more surguries today. Come on in!" << endl;
  }
  else if (money < price)
  {
  ...
  {
  surg3 = money / price;
  cout << "Sorry " << name << ", you can only afford " << static_cast<short>(surg3) << ". Still, come on in!" << endl;
  }
...
cout << "Thank you for using the Dr. Nick's recepitionist bot. Please have a great day!" << endl;
